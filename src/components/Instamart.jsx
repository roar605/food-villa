...
const Section=(props)=>{
    ...
    return(
        <div className="p-4 m-5 border border-black">
        <h1>{props.title}</h1>
        {isVisible?<button className="underline text-red-600" onClick={()=>setIsVisible(false)}>Hide</button>:
        <button onClick={()=>setIsVisible(true)} className="underline text-red-600">Show</button>
        }
